    ...
    return (
      <div className="mx-auto my-20 max-w-[350px] space-y-6 rounded-xl bg-white px-4 pb-8 pt-4 font-sans shadow-lg dark:bg-[#18181B]">
          <div className="relative flex h-48 w-full justify-center lg:h-[280px]">
              ...
              <img width={300} height={300} className="h-full w-full rounded-lg bg-black/40" src={product?.imgLink} alt="card navigate ui" />
          </div>
          <div className="mx-auto w-[85%] space-y-2 text-center font-semibold">
              <h6 className="text-xs md:text-base lg:text-lg">{product?.name}</h6>
              <h6 className="text-sm md:text-base lg:text-lg">{product?.price}</h6>
              <p className="text-xs font-semibold text-gray-400 md:text-sm">{product?.desc}</p>
          </div>
